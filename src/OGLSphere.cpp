...
void OGLSphere::buildInterleavedVertices()
{
...
void OGLSphere::addTexCoord(float s, float t)
{
    texCoords.push_back(s);
    texCoords.push_back(t);
}

void OGLSphere::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
void OGLSphere::addNormal(float nx, float ny, float nz)
{
...
void OGLSphere::addVertex(float x, float y, float z)
{
...
std::vector<float> OGLSphere::computeFaceNormal(float x1, float y1, float z1,  // v1
